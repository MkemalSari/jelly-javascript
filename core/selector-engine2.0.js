	...
	var	pushToStack = function ( value ) {
		...
		pseudoTests = {
			'nth-child': function ( tags, tkn ) {
				return nthChildFilter( tags, tkn.val, 0, 0, tkn.not );
			},
			'nth-of-type': function ( tags, tkn ) {
				return nthChildFilter( tags, tkn.val, 1, 0, tkn.not );
			},
			'nth-last-child': function ( tags, tkn ) {
				return nthChildFilter( tags, tkn.val, 0, 1, tkn.not );
			},
			'nth-last-of-type': function ( tags, tkn ) {
				return nthChildFilter( tags, tkn.val, 1, 1, tkn.not );
			},
			'first-of-type': function ( tags, tkn ) {
				return nthChildFilter( tags, '1', 1, 0, tkn.not );
			},
			'last-of-type': function ( tags, tkn ) {
				return nthChildFilter( tags, '1', 1, 1, tkn.not );
			},
